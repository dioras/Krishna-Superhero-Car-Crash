...
public class RCC_Damage {
    ...
    private void CheckMeshData() {
        ...
        {
            if (originalMeshData[i].meshVerts != null && meshFilters[i] != null)
            {
    ...
    private void CheckWheelData() {
        ...
        for (int i = 0; i < wheels.Length; i++) {
            if (originalWheelData[i].wheelPosition != null && wheels[i] != null)
            {
        ...
        for (int i = 0; i < wheels.Length; i++) {
            if (damagedWheelData[i].wheelPosition != null && wheels[i] != null)
            {
    ...
    {
        GameplayUIManager.Agent.RepairButton.SetActive(true);
    }
